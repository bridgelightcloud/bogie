...
var (
	validColor = regexp.MustCompile(`(?i)^[a-f0-9]{6}$`)
)
...
func parseCurrencyCode(v string) (currencyCode, error) {
	if _, ok := validCurrencyCodes[v]; !ok {
...
// func parseCurrencyAmount(data string, currency currencyCode) (int, error) {
