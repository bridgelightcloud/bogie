...
func TestUnmarshalValue(t *testing.T) {
	...
	tt := map[string]struct {
		...
		"customTextMarshalerError": {customMarshalAndUnmarshal{}, "", customMarshalAndUnmarshal{}, ptr[*UnmarshalValueError](nil)},
